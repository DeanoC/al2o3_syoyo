#pragma once
#ifndef AL2O3_SYOYO_TINY_EXR_H
#define AL2O3_SYOYO_TINY_EXR_H
...
// error
AL2O3_EXTERN_C int TinyExr_LoadEXRImage(TinyExr_EXRImage *image, const TinyExr_EXRHeader *header,
                                  VFile_Handle handle);
...
// Returns negative value and may set error string in `err` when there's an
// error
AL2O3_EXTERN_C int TinyExr_LoadEXRMultipartImage(TinyExr_EXRImage *images,
...
// Returns negative value and may set error string in `err` when there's an
// error
AL2O3_EXTERN_C int TinyExr_SaveEXRImage(const TinyExr_EXRImage *image,
...
// Returns negative value and may set error string in `err` when there's an
// error
AL2O3_EXTERN_C int TinyExr_LoadDeepEXR(TinyExr_DeepImage *out_image,
                                 VFile_Handle handle);
